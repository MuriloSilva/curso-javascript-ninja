...
(function() {
    ...
    */
   const isOperatorValid = (operator) => operator in operation
    ...
    */
    const calculator = (operator) => {
        if(isOperatorValid(operator))
            return function(x,y){
                const parameterNotANumber = (typeof x !=='number' || typeof y !=='number')
                return parameterNotANumber ? false : operation[operator](x,y)
            }    
    ...
    */
    const shorErrorMessage = (operator) => `Operação "${operator}" não permitida!`
    ...
    */
   opertationSignal = '+'
   let sum = calculator(opertationSignal)
    ...
    */
    if(sum){
        number1 = 10
        number2 = 30
        console.log(showOperationMessage(opertationSignal,number1,number2), sum(number1,number2))
    }
   ...
   opertationSignal = '-'
   let subtraction = calculator(opertationSignal)
   if(subtraction){
        number1 = 10
        number2 = 30
        console.log(showOperationMessage(opertationSignal,number1,number2), subtraction(number1,number2))
    }
   
   opertationSignal = '*'
   let multiplication = calculator(opertationSignal)
   if(multiplication){
        number1 = 10
        number2 = 30
        console.log(showOperationMessage(opertationSignal,number1,number2), multiplication(number1,number2))
    }

   opertationSignal = '/'
   let division = calculator(opertationSignal)
   if(division){
        number1 = 10
        number2 = 30
        console.log(showOperationMessage(opertationSignal,number1,number2), division(number1,number2))
    }   
   
   opertationSignal = '%'
   let mod = calculator(opertationSignal)
   if(mod){
        number1 = 100
        number2 = 30
        console.log(showOperationMessage(opertationSignal,number1,number2), mod(number1,number2))
    }
    ...
    */
   opertationSignal = '$'
   let any = calculator(opertationSignal)
   if(any){
        number1 = 100
        number2 = 30
        console.log(showOperationMessage(opertationSignal,number1,number2), mod(number1,number2))
    } else {
        console.log(shorErrorMessage(opertationSignal), new Date(), `(${typeof new Date()})`)
    }
})()