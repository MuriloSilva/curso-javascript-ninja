...
(() => {
    ...
    */
    ...
    console.log(text.replace(/manuel.*sousa/i, 'Murilo Rodrigues de Paula'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas"/g, content => content.toUpperCase()))
    ...
    */
    const getMonthNumber = monthName => 
        ...
        })[monthName.toLowerCase()] || "00"

    console.log('\nMeses representados por números:');
    const monthDescription = monthName => console.log(`O mês de ${monthName} é representado pelo número ${getMonthNumber(monthName)}.`)
    ...
    */
    const regexDate = (/(\d{2}) de (janeiro|junho|julho) de (\d{4})/g)
    console.log('\nRegex que vai fazer o match com as datas do texto:', '/(\\d{2}) de (junho|julho) de (\\d{4})/g');
    // ?
    ...
    */
    console.log('\nReplace de datas:');
    const replaceDate = (fullMatch, dia, mes, ano) => `${dia}/${getMonthNumber(mes)}/${ano}`
